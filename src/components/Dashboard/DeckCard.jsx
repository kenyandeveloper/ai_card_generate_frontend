...
const DeckCard = ({ deck, deckStats, theme, navigate, isMobile }) => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
        {/* Header */}
